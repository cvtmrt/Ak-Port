...
export const site = {
  ...
  seoDescription:
    "İncek, Gölbaşı ve Ankara'da akü satışı, yerinde montaj ve acil akü hizmeti. Mutlu, Varta, Bosch, İnci aküleri. Hemen arayın: 0544 479 29 59.",
  logo: "/images/akuport-logo-3d.jpeg", // schema.org image + favicon fallback
  favicon: "", // boş ise logo kullanılır
  address: {
...
export const districts = [
  ...
  },
  {
    ...
    intro:
      "Ümitköy'de akücü arıyorsanız doğru yerdesiniz. Ümitköy ve çevresine yerinde akü değişimi ve acil yol yardım. Ankara'nın her yerine hizmet veriyoruz.",
  },
  {
    slug: "cankaya",
    name: "Çankaya",
  ...
  },
  {
    ...
    intro:
      "Ankara'da akü, yerinde akü değişimi ve acil akü hizmeti. Tüm marka ve amperlerde otomobil, ticari araç, kamyon ve motosiklet aküsü.",
  },
];
