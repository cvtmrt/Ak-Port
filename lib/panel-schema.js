...
export const collections = {
  products: {
    ...
    fields: [
      ...
      { key: "images", label: "Galeri Görselleri", type: "tags", hint: "URL'leri virgülle ayırın" },
...
export const homeSections = [
  ...
  },
  {
    ...
    fields: [
      { key: "bulucuKicker", label: "Akü Bulucu — Üst Etiket", type: "text" },
      { key: "bulucuTitle", label: "Akü Bulucu — Başlık", type: "text" },
      { key: "bulucuDesc", label: "Akü Bulucu — Açıklama", type: "text" },
...
export const homeDefaults = {
  ...
  bulucuKicker: "Hangi Akü?",
  bulucuTitle: "Aracına Uygun Aküyü Bul",
  bulucuDesc: "Marka ve modelini seç, doğru amper ve teknolojiyi önerelim.",
