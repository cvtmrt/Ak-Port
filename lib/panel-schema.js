...
export const homeSections = [
  {
    ...
    label: "Hero (Üst Alan)",
    fields: [
      { key: "heroSlides", label: "Slaytlar (rozet + başlık + alt metin)", type: "slides", hint: "arka plan sabit kalır, slaytlar otomatik döner" },
      ...
      { key: "heroBgImage", label: "Hero Arka Plan Görseli", type: "image", hint: "boş bırakılırsa koyu degrade arka plan kullanılır" },
    ],
  },
  {
    id: "trust",
...
export const homeDefaults = {
  ...
  heroSubtitle:
    "Aküm bitti diyene en yakın akücü. Otomobil, ticari, kamyon ve motosiklet aküsünde tüm marka ve amperler, yerinde montaj ile.",
  heroSlides: [
    {
      badge: "⚡ İncek · Gölbaşı · Ankara",
      title1: "İncek & Gölbaşı Akü",
      title2: "Yerinde Montaj & Acil Akü",
      subtitle: "Aküm bitti diyene en yakın akücü. Otomobil, ticari, kamyon ve motosiklet aküsünde tüm marka ve amperler, yerinde montaj ile.",
    },
    {
      badge: "🚗 Acil Yol Yardım",
      title1: "Yolda mı Kaldınız?",
      title2: "Hemen Geliyoruz",
      subtitle: "Ankara içi acil akü ve yol yardım. Konumunuzu söyleyin, uygun aküyle en kısa sürede yanınızdayız.",
    },
  ],
  heroFeatures: ["Yerinde montaj", "Acil akü hattı", "Eski akü takas"],
  heroImage: "/images/akuport-logo.jpeg",
  heroBgImage: "",
  trustCards: [
    { title: "Yerinde Montaj", text: "İncek & Gölbaşı'na yerinde akü değişimi" },
    { title: "Acil Akü Hattı", text: "Aküm bitti diyene hızlı yol yardım" },
...
export const settingsFields = [
  ...
  { key: "logo", label: "Logo (Google/SEO görseli)", type: "image", hint: "arama sonucunda ve yapısal veride görünen logo; kare görsel önerilir" },
  { key: "seoTitle", label: "Google Başlığı (SEO)", type: "text", hint: "arama sonucundaki mavi başlık; boşsa varsayılan" },
  { key: "seoDescription", label: "Google Açıklaması (SEO)", type: "textarea", hint: "arama sonucundaki gri açıklama; boşsa varsayılan" },
  { key: "favicon", label: "Favicon (sekme ikonu)", type: "image", hint: "kare görsel; boş bırakılırsa logo kullanılır" },
];
...
export const designDefaults = {
  ...
  heroSubtitle: "Aküm bitti diyene en yakın akücü. Otomobil, ticari, kamyon ve motosiklet aküsünde tüm marka ve amperler, yerinde montaj ile.",
};
