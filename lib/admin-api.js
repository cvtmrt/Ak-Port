...
//
// collection: "posts" | "reviews" | "brands" | "districts" | "pages"
...
// Geçerli bir admin oturumu (cookie) var mı? Sayfa yenilemede otomatik giriş için.
export async function apiHasSession() {
  try {
