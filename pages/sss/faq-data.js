// S.S.S. soruları — hem sayfada gösterilir hem FAQPage JSON-LD'de kullanılır.
export const faqItems = [
  ...
  { q: "Kışın akü neden daha çabuk biter?", a: "Soğukta akünün kimyasal performansı düşer ve marş için daha fazla güç gerekir. Bu yüzden ömrünü tamamlamaya yakın aküler en çok kışın pes eder." },
  { q: "Hangi ödeme yöntemlerini kabul ediyorsunuz?", a: "Nakit ve kredi kartı ile ödeme alıyoruz. Detaylar için bizi arayabilirsiniz." },
  { q: "Aküde garanti var mı?", a: "Evet, sattığımız aküler üretici garantilidir. Marka ve modele göre garanti süresi değişir; satış sırasında bilgilendiriyoruz." },
];
